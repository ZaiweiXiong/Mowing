...
?>
    ...
    <table class='table table-hover table-responsive table-bordered'>
        <tr>
            <td>Suburb</td>
            <td><input type='text' name='suburb' id="suburb" value="<?php echo $myId ?>" class='form-control'/></td>
        </tr>
        <tr>
            <td>Post Code</td>
        ...
        <tr>
            ...
            <td>
                ...
                <a href='http://localhost/mowing/CodeIgniter/index.php/lawn/' class='btn btn-danger'>Back</a>
            </td>
        </tr>
    </table>
