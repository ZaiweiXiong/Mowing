...
?>
    ...
    <table class='table table-hover table-responsive table-bordered'>
            <tr>
            <td hidden >ID</td>
            <td hidden ><input type='text' name='ID' id="id" value="<?php echo $myId  ?>" class='form-control'/></td>
        </tr>
        <tr>
            <td>Suburb</td>
            <td><input type='text' name='suburb' id="suburb" value="<?php echo $mysub ?>" class='form-control'/></td>
        </tr>
        <tr>
            <td hidden>Post Code</td>
            <td hidden><input type='text' name='postcode' id="postcode"  value="<?php echo $myId  ?>" class='form-control' /></td>
        </tr>
        <tr>
            <td>Address</td>
		...
		<tr>
            <td>Date</td>
            <td> <input type="text"  name='date' value="<?php echo $mydate ?>" id="datepicker" class='form-control'/></td>
        ...
        <tr>
		 ...
		 <tr>
            <td>Pay</td>
            <td><input type='text' name='pay' id='pay' class='form-control' value="<?php echo $mypay ?>"/></td>
        </tr>
        <tr>
            <td></td>
            <td>
                <input type='button' value='Edit' id="edit" class='btn btn-primary' />
                <a href='http://localhost/mowing/CodeIgniter/lawn/index.php' class='btn btn-danger'>Back</a>
            </td>
        </tr>
    </table>
